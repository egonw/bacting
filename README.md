...
Java 11, 14, and 17, and can be installed with:
...
mvn versions:set -DnewVersion=0.0.44
...
```shell
mvn versions:set -DnewVersion=0.0.45-SNAPSHOT
mvn deploy
```
...
```groovy
@Grab(group='io.github.egonw.bacting', module='managers-cdk', version='0.0.44')
...
config.add_endpoints('io.github.egonw.bacting:managers-cdk:0.0.44')
