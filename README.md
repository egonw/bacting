...
mvn versions:set -DnewVersion=0.0.40
...
```shell
mvn versions:set -DnewVersion=0.0.42-SNAPSHOT
mvn deploy
```
...
```groovy
@Grab(group='io.github.egonw.bacting', module='managers-cdk', version='0.0.41')
...
config.add_endpoints('io.github.egonw.bacting:managers-cdk:0.0.41')
