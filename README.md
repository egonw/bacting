...
```groovy
@Grab(group='io.github.egonw.bacting', module='managers-cdk', version='1.0.10')
...
Bacting can also be used in Python 3.7 (and higher) with [pybacting](https://github.com/cthoyt/pybacting) and
...
config.add_endpoints('io.github.egonw.bacting:managers-cdk:1.0.10')
